...
const articles = [
  ...
  },
  {
    ...
    sections: [
      ...
      { h: 'Para vos que estás lejos, lo online suma', body: [{ p: 'Estar a distancia deja de ser un obstáculo: podés elegir al profesional por afinidad y no por cercanía geográfica, y sostener el proceso aunque te mudes o viajes. No dependés de quién haya "en tu zona" — elegís con quién querés trabajar, y eso ya es mucho.' }] },
  ...
  },
  {
    ...
    sections: [
      { h: '"Ir al psicólogo es para cuando estás mal"', body: [{ p: 'Es el mito más instalado, y el que más frena. Pero no hace falta estar al límite para que la terapia sume: también es un espacio para prevenir, para conocerte mejor o para atravesar un cambio con más herramientas. Esperar a "estar mal" es, justamente, lo que hace que muchos lleguen más tarde de lo necesario.' }] },
